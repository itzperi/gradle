...
export default function MicTester() {
  ...
  const startMicTest = async () => {
    ...
    try {
      ...
      setError(err.message || 'Error accessing microphone. Check permissions.');
      setTestStatus('error');
    }
  };
  ...
  const getStatusIcon = () => {
    switch (testStatus) {
      case 'testing': return <Waves className="animate-pulse" size={40} />;
      case 'success': return <CheckCircle2 className="text-green-400" size={40} />;
      case 'error': return <AlertTriangle className="text-red-400" size={40} />;
    ...
    <div className="min-h-screen flex flex-col items-center justify-center p-4 
      ...
      <div className="relative z-10 w-full max-w-md">
        <div className="bg-slate-900/60 backdrop-blur-2xl 
          border border-slate-800/50 rounded-3xl 
            ...
            {!isListening ? (
              ...
              <div className="space-y-6">
                ...
                <div className="flex space-x-4">
                  ...
                  <button 
                    ...
                    className="flex-1 bg-slate-700/30 
                    hover:bg-slate-700/50 
                    text-slate-200 py-3 rounded-lg 
                    flex items-center justify-center 
                    space-x-2 transition-all duration-300"
                  >
                    <RefreshCw size={20} />
              ...
              {error && (
                <div className="mt-4 text-red-400 text-center 
                  ...
                  border-red-500/20 flex flex-col items-center">
